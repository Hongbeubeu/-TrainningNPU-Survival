Shader "Npu/Basic (Greyscale)"
{
    Properties
    {
        _MainTex ("Diffuse Texture", 2D) = "white" {}
        _Color ("Color Tint", Color) = (1.0,1.0,1.0,1.0)
        _GreyFactor("Grey Factor", Range(0, 1)) = 0
        _Index ("Index", int) = 0
...
#pragma vertex vert
            ...
            half4 frag(vertexOutput i) : COLOR
            {
                ...
                half greyFactor = UNITY_ACCESS_INSTANCED_PROP(InstanceProperties, _GreyFactor);
                ...
                color.rgb = GREYSCALE(color.rgb, greyFactor);
