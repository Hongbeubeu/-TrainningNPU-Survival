...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty isShowButton;

    protected Vector2 center = new Vector2(0.5f, 0.5f);

    protected virtual void OnEnable()
    {
        isShowButton = serializedObject.FindProperty("IsShowButton");
    ...
    {
        EditorGUILayout.PropertyField(isShowButton, new GUIContent("Is Show Button"));
